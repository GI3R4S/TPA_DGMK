...
namespace BusinessLogic.Mapping
{
    public class MethodMetadataMapper
    {
        ...
        public MethodMetadata MapUp(MethodMetadataBase metadata)
        {
            ...
            if (returnType != null)
                methodMetadata.ReturnType = TypeMetadataMapper.EmitType(returnType);
            return methodMetadata;
        }

        public MethodMetadataBase MapDown(MethodMetadata model, Type methodMetadataType)
        {
            ...
            if (model.ReturnType != null)
                returnTypeProperty?.SetValue(methodMetadata,
                    returnTypeProperty.PropertyType.Cast(TypeMetadataMapper.EmitBaseType(model.ReturnType, returnTypeProperty.PropertyType)));
